  ...
  return (
    <div className='bg-gray-950'>
      <div className='max-w-7xl mx-auto items-center flex flex-col py-8 px-4 md:px-8 min-h-screen'>
        ...
        className='text-gray-300 text-center max-w-xl mb-12'>Have questions or ideas? Get in touch and let’s create something amazing together.</motion.p>
        <div className='grid md:grid-flow-col gap-10'>
          ...
          className='bg-[#c7e9ec] shadow-xl shadow-[#33CCCC] rounded-lg p-8 md:p-12 max-w-3xl w-full flex flex-col items-center md:flex-row gap-7 space-y-6 md:space-y-0 md:space-x-8'>
            ...
            <div>
              ...
              <iframe 
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3153.020537392707!2d-122.41941548468165!3d37.77492977975953!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8085809cbaeebd45%3A0x4a0f0e9c6b9cb5a9!2sSan%20Francisco%2C%20CA!5e0!3m2!1sen!2sus!4v1693929301023!5m2!1sen!2sus"
