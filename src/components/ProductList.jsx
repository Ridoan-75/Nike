...
const ProductList = (props) => {
  return (
    <div className='mx-auto max-w-2xl px-4 py-16 sm:py-24 lg:max-w-7xl lg:px-8'>
        ...
        <p className='text-center mt-3 md:px-56'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Architecto, non molestias commodi eius reprehenderit quas.</p>
